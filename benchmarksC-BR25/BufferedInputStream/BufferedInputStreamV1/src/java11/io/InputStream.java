 ...
 * @see     java12.io.BufferedInputStream
 * @see     java.io.ByteArrayInputStream
 * @see     java.io.DataInputStream
 * @see     java12.io.FilterInputStream
 * @see     java12.io.InputStream#read()
...
public abstract class InputStream {
     ...
     * @exception  IOException  if an I/O error occurs.
     * @see        java12.io.InputStream#read(byte[], int, int)
     */
